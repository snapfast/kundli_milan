# User Stories - Vedic Astrology Matchmaker
...
### 3. Cosmic Matchmaking
**As a user looking for a partner**, I want the system to compare my astrological profile with other users using the Ashta Koota (36-point) system, **so that** I can find people with the highest cosmic compatibility.
